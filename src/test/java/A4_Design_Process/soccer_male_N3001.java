...
public class soccer_male_N3001 {
...
//		htmlReporter = new ExtentHtmlReporter("soccer_male_N3001.html");
...
//		extent.attachReporter(htmlReporter);
	...
	public void select_style_decoration() throws InterruptedException {
		 ...
		 */
		driver.findElement(By.xpath("//img[@alt='N3001']")).click();
		driver.findElement(By.xpath("//div[@data-color-id='20']")).click();
		...
		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//img[@data-object='226']")).click();
		Thread.sleep(3000);
