...
public class track_youth_NB4234 {
...
//		htmlReporter = new ExtentHtmlReporter("track_youth_NB4234.html");
...
//		extent.attachReporter(htmlReporter);
	...
	public void select_sport() throws InterruptedException {
		...
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//img[@alt='Track']")).click();
	}
	...
	public void select_gender_garment() {
		...
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//a[@data-garment-id='5'][@data-gender-id='3']")).click();
	...
	public void select_style_decoration() throws InterruptedException {
		...
		driver.findElement(By.xpath("//img[@src='https://s3.amazonaws.com/a4-assets/styles/thumbnails/000/000/180/original/NB.PNG?1534573384']")).click();
		driver.findElement(By.xpath("//div[@data-color-id='117']")).click();
