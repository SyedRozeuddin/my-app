...
public class volleyball_male_N4268 {
...
//		htmlReporter = new ExtentHtmlReporter("volleyball_male_N4268.html");
...
//		extent.attachReporter(htmlReporter);
	...
	public void select_style_decoration() throws InterruptedException {
		 ...
		 */
		driver.findElement(By.xpath("//img[@alt='N4268']")).click();
		...
		driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//img[@data-object='230']")).click();
		Thread.sleep(3000);
