...
public class soccer_youth_NB3373 {
...
//		htmlReporter = new ExtentHtmlReporter("soccer_youth_NB3373.html");
...
//		extent.attachReporter(htmlReporter);
	...
	public void select_style_decoration() throws InterruptedException {
		 ...
		 */
		driver.findElement(By.xpath("//img[@alt='N3373']")).click();
		driver.findElement(By.xpath("//div[@data-color-id='50']")).click();
		...
		driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//img[@data-object='224']")).click();
		Thread.sleep(3000);
