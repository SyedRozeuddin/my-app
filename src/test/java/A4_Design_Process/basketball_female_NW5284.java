...
public class basketball_female_NW5284 {
...
//		htmlReporter = new ExtentHtmlReporter("basketball_female_NW5284.html");
//		extent = new ExtentReports();
//		extent.attachReporter(htmlReporter);
		System.setProperty("webdriver.chrome.driver",
				"C:\\Users\\A\\Downloads\\chromedriver_win32 (1)\\chromedriver.exe");
	...
	public void select_gender_garment() {
		 ...
		 */
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//a[@data-garment-id='6'][@data-gender-id='2']")).click();
	...
	public void select_style_decoration() throws InterruptedException {
		...
		driver.findElement(By.xpath("//div[@data-color-id='57']")).click();
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//img[@data-object='92']")).click();
		Thread.sleep(3000);
