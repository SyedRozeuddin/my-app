...
public class track_female_NW5341 {
	...
	public void setbrowser() {
		htmlReporter = new ExtentHtmlReporter("track_female_NW5341.html");
	...
	public void select_style_decoration() throws InterruptedException {
		...
		driver.findElement(By.xpath("//img[@alt='Nw5341']")).click();
		driver.findElement(By.xpath("//div[@data-color-id='52']")).click();
		...
		driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//img[@data-object='124']")).click();
		Thread.sleep(3000);
