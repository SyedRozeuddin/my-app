...
public class volleyball_youth_NB5244 {
...
//		htmlReporter = new ExtentHtmlReporter("volleyball_youth_NB5244.html");
...
//		extent.attachReporter(htmlReporter);
	...
	public void select_sport() throws InterruptedException {
		...
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//img[@alt='Volleyball']")).click();
	}
	...
	public void select_style_decoration() throws InterruptedException {
		 ...
		 */
		driver.findElement(By.xpath("//img[@src='https://s3.amazonaws.com/a4-assets/styles/thumbnails/000/000/189/original/Capture.PNG?1534266316']")).click();
		driver.findElement(By.xpath("//button[contains(text(),'CRD')]")).click();
		...
		driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//img[@data-object='225']")).click();
		Thread.sleep(3000);
