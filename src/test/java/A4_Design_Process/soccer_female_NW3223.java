...
public class soccer_female_NW3223 {
...
//		htmlReporter = new ExtentHtmlReporter("soccer_female_NW3223.html");
...
//		extent.attachReporter(htmlReporter);
	...
	public void select_sport() throws InterruptedException {
		...
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//img[@alt='Soccer']")).click();
	}
	...
	public void select_gender_garment() {
		 ...
		 */
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//a[@data-garment-id='8'][@data-gender-id='2']")).click();
	...
	public void select_style_decoration() throws InterruptedException {
		 ...
		 */
		driver.findElement(By.xpath("//img[@alt='Nw3223']")).click();
		driver.findElement(By.xpath("//div[@data-color-id='150']")).click();
		...
		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//img[@data-object='93']")).click();
		Thread.sleep(3000);
