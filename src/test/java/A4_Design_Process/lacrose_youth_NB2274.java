...
public class lacrose_youth_NB2274 {
	/*
	 * public ExtentTest test; public ExtentHtmlReporter htmlReporter; public
	...
	public void setbrowser() {
		/*
		 * htmlReporter = new ExtentHtmlReporter("lacrose_youth_NB2274.html"); extent =
	...
	public void select_gender_garment() {
		/*
		 * test = extent.createTest("gender and garment selection",
		 * "test for gender and garment selection");
		 * test.info("test of garment selection funtionality of A4 is passed");
		 * test.pass("garment and gender selection was successful");
		 */
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//a[@data-garment-id='2'][@data-gender-id='3']")).click();

	}
	@Test(dependsOnMethods = {"select_gender_garment"})
	public void select_style_decoration() throws InterruptedException {
		/*
		 * test = extent.createTest("select style of garment and also decoration",
		 * "test for style and decoration selection"); test.
		 * info("test of style and decoration selection funtionality of A4 is passed");
		 * test.pass("style plus decoration selection was successful");
		 */
		driver.findElement(By.xpath("//img[@alt='Nb']")).click();
		driver.findElement(By.xpath("//div[@data-color-id='46']")).click();
...
//		this is to add another decoration
		 ...
		 * Select sel2 = new
		 * Select(driver.findElement(By.xpath("//select[@id='style_method']")));
		 * sel2.selectByIndex(1); Thread.sleep(2000);
		 * driver.findElement(By.xpath("//a[@id='complete_decoration_btn']")).click();
		 * driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS); // this is
	...
	public void select_quantity() {
		/*
		 * test = extent.createTest("quantity selection",
		 * "test for quantity selection");
	...
	public void orderacknowledgement() {
		/*
		 * test = extent.createTest("order acknowledgement",
		 * "test for orderacknowledgement page");
