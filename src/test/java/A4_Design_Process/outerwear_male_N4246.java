...
public class outerwear_male_N4246 {
	/*
...
//		htmlReporter = new ExtentHtmlReporter("outerwear_male_N4246.html");
...
//		extent.attachReporter(htmlReporter);
	...
	public void select_gender_garment() {
		 ...
		 */
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//a[@data-garment-id='5'][@data-gender-id='1']")).click();
	...
	public void select_style_decoration() throws InterruptedException {
		 ...
		 */
		driver.findElement(By.xpath("//img[@alt='N4246']")).click();
		driver.findElement(By.xpath("//div[@data-color-id='24']")).click();
