...
public class basketball_male_NF1270 {
	/*
	...
	public void setbrowser() {
		/*
		 * htmlReporter = new ExtentHtmlReporter("basketball_male_NF1270.html"); extent
	...
	public void select_gender_garment() {
		 ...
		 */
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//a[@data-gender-id='1'][@data-garment-id='2']")).click();
	...
	public void select_style_decoration() throws InterruptedException {
		 ...
		 */
		driver.findElement(By.xpath("//img[@alt='Nf1270']")).click();
	...
	public void select_quantity() {
		 ...
		 * System.out.println("Unit Price  " + unitprice1);
