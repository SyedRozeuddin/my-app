...
public class T1_baseball_youth_NB3165_shirts_youth_cooling_performance_long_sleeve_crew {
...
//		this is to select the gender and the garment
		driver.findElement(By.xpath("//a[@data-gender-id='3'][@data-garment-id='8']")).click();
...
//		this is to select the style
		driver.findElement(By.xpath("//img[@alt='N3165']")).click();
