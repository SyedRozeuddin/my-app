...
public class T2_baseball_female_NW3143_jerseys_Tek2_Button_Henley {
...
//		this is to select the gender and the garment
		driver.findElement(By.xpath("//a[@data-gender-id='2'][@data-garment-id='2']")).click();
...
//		this is to select the style
		driver.findElement(By.xpath("//img[@alt='Nw3143']")).click();
