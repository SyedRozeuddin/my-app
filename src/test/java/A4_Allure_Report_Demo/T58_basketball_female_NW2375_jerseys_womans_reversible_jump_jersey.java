...
public class T58_basketball_female_NW2375_jerseys_womans_reversible_jump_jersey {
...
//		Thread.sleep(2000);
	...
	public void select_gender_garment() {
		...
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//a[@data-garment-id='2'][@data-gender-id='2']")).click();

	}
	@Test(dependsOnMethods = {"select_gender_garment"})
	public void select_style_decoration() throws InterruptedException {
	
		driver.findElement(By.xpath("//img[@src='https://s3.amazonaws.com/a4-assets/styles/thumbnails/000/000/218/original/Capture.PNG?1534575517']")).click();
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//a[@data-placement='B13']")).click();
