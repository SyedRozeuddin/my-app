...
public class T69_baseball_youth_NB4241_jackets_zip_batting_style {
...
//		this is to select the color
		driver.findElement(By.xpath("//button[contains(text(),'SCR')]")).click();
//		save the color
...
//		this is to select the place order button
	 ...
	 * get the ids of different windows being opened in the arraylist
