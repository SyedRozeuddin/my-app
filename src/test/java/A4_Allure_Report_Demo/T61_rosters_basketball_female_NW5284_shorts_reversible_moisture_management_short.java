...
public class T61_rosters_basketball_female_NW5284_shorts_reversible_moisture_management_short {
...
//		Thread.sleep(2000);
	...
	public void select_gender_garment() {
		...
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//a[@data-garment-id='1'][@data-gender-id='1']")).click();

	}
	@Test(dependsOnMethods = {"select_gender_garment"})
	public void select_style_decoration() throws InterruptedException {
	
		driver.findElement(By.xpath("//img[@alt='N4261']")).click();
...
//		this is to add the item in the cart
	...
	public void rosters() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@placeholder='Enter Roster Name'][@id='team_name']")).sendKeys("Agha Team");
		driver.findElement(By.xpath("//div[@id='roster_modal_content']//tr[1]//td[1]//input[1]")).sendKeys("dayan1");
		
		driver.findElement(By.xpath("//td[@class='col-xs-2']//input[@id='team_team_players__number']")).sendKeys("0316845712");
