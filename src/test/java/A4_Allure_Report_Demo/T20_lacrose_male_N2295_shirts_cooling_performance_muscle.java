...
public class T20_lacrose_male_N2295_shirts_cooling_performance_muscle {
...
//		driver.findElement(By.xpath("//a[@id='skip_tutorial']")).click();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
...
//		save the color
		...
		driver.manage().timeouts().implicitlyWait(170, TimeUnit.SECONDS);
