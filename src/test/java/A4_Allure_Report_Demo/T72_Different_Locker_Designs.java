...
public class T72_Different_Locker_Designs {
...
//			driver.findElement(By.xpath("//input[@value='Login']")).click();
		...
		public void AddToCart() throws InterruptedException {
			...
			driver.findElement(By.xpath("//a[contains(@href,'/customer/orders/new?uniform_id=3762')][text()='Add to Cart']")).click();
			Thread.sleep(2000);
		...
		public void Select_Quantity() throws InterruptedException {
			...
			driver.findElement(By.xpath("//input[@id='quantity_LXL']")).clear();
			driver.findElement(By.xpath("//input[@id='quantity_LXL']")).sendKeys("15");
		...
		public void AddToCart3() throws InterruptedException {
			...
			driver.manage().timeouts().implicitlyWait(30,TimeUnit.SECONDS);
			driver.findElement(By.xpath("//a[contains(@href,'/customer/orders/new?uniform_id=3754')][text()='Add to Cart']")).click();
			Thread.sleep(2000);	
		...
		public void AddToCart4() throws InterruptedException {
			...
			driver.manage().timeouts().implicitlyWait(30,TimeUnit.SECONDS);
			driver.findElement(By.xpath("//a[contains(@href,'/customer/orders/new?uniform_id=3700')][text()='Add to Cart']")).click();
			Thread.sleep(2000);	
		...
		public void Select_Quantity4() throws InterruptedException {
			...
			driver.findElement(By.xpath("//input[@id='quantity_S']")).clear();
			driver.findElement(By.xpath("//input[@id='quantity_S']")).sendKeys("10");
		...
		public void PlaceOrder() throws InterruptedException  {
			...
			driver.findElement(By.xpath("//input[@id='request_shipping_date']")).sendKeys("06102019");
