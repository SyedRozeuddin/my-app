...
public class T8_baseball_youth_NB4241_jackets_zip_batting_style {
	...
	public void setbrowser() {
		...
		/*
		 * htmlReporter = new ExtentHtmlReporter("baseball_youth_NB6603.html"); extent =
...
//		// click on login button
	...
	public void select_gender_garment() {
		 ...
		 */
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//a[@data-gender-id='3'][@data-garment-id='1']")).click();
	...
	public void select_style_decoration() throws InterruptedException {
		...
		driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//a[@data-placement='F03']")).click();
		driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
