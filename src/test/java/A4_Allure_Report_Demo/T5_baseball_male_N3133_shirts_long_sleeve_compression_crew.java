...
public class T5_baseball_male_N3133_shirts_long_sleeve_compression_crew {
...
//		this is to select the gender and the garment
		driver.findElement(By.xpath("//a[@data-gender-id='1'][@data-garment-id='8']")).click();
...
//		this is to select the style
		driver.findElement(By.xpath("//img[@alt='N3133']")).click();
