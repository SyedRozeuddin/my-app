...
public class T6_baseball_male_N4184_jerseys_short_sleeve_full_button_baseball_jersey {
...
//		this is to select the style
		driver.findElement(By.xpath("//img[@src='https://s3.amazonaws.com/a4-assets/styles/thumbnails/000/000/174/original/Capture.PNG?1534401168']")).click();
...
//		this is to select the decoration
		...
		driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//img[@data-object='189']")).click();
		Thread.sleep(3000);
...
//		this is to select the place order button
	 ...
	 * 
	 * driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS); // this is to
	 * get the ids of different windows being opened in the array list
	 * ArrayList<String> list = new ArrayList<String>(driver.getWindowHandles());
	 * driver.switchTo().window(list.get(1)); // this is to get the final art proof
	 * price from order acknowledgement String orderack_art_proof =
	 * driver.findElement(By.xpath("//span[1]//strong[1]")).getText(); // this is to
	 * get the final total price of item in order acknowledgement String
	 * orderack_subtotal =
