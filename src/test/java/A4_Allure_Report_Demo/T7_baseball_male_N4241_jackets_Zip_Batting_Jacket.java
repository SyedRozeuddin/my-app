...
public class T7_baseball_male_N4241_jackets_Zip_Batting_Jacket {
...
//		this is to select the placeorder button
	 ...
	 * this is to create test report on this particular test // test =
	 * extent.createTest("order acknowledgement",
