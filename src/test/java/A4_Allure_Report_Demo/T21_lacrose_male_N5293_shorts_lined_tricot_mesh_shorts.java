...
public class T21_lacrose_male_N5293_shorts_lined_tricot_mesh_shorts {
...
//		Thread.sleep(2000);
	...
	public void select_gender_garment() {
		...
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//a[@data-garment-id='6'][@data-gender-id='1']")).click();

	}
	@Test(dependsOnMethods = {"select_gender_garment"})
	public void select_style_decoration() throws InterruptedException {
		
		driver.findElement(By.xpath("//img[@alt='N5293']")).click();
	...
	public void select_quantity() {
		...
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//input[@id='quantity_XS']")).clear();
		driver.findElement(By.xpath("//input[@id='quantity_XS']")).sendKeys("5");
