...
public class Mens_Basic_Shirt_N3165 {
	 ...
	 @BeforeTest
		...
		public void profile() {
			...
			driver.findElement(By.xpath("//div[@class='row']//div[8]//div[1]//div[1]//div[2]//div[2]//a[@role='button']")).click();
...
//			after selecting the edit design select color of that uniform
			driver.findElement(By.xpath("//button[contains(text(),'SFY')]")).click();
...
//    this is to save the entire the uniform edit and move back to the design locker
		...
		public void add_to_cart() throws InterruptedException{
			...
			driver.findElement(By.xpath("//div[@class='row']//div[8]//div[2]//div[1]//div[2]//div[2]//a[contains(text(),'Add to Cart')]")).click();
