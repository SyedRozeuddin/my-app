...
public class Baseball_Mens_Jersey_N4184 {
	 ...
	 static String url = "https://customa4.com/";
		...
		public void profile() {
			...
			driver.findElement(By.xpath("//div[@id='design_archives']//div[1]//div[1]//div[1]//div[2]//div[2]//div[1]//a[@role='button']")).click();
...
//			this is to select the edit design for the duplicated uniform
			driver.findElement(By.xpath("//div[@id='design_archives']//div[1]//div[2]//div[1]//div[2]//div[2]//a[text()='Edit this Design']")).click();
		...
		public void edit_design() throws InterruptedException {
			driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
//			after selecting the edit design select colour of that uniform
...
//			select the uniform and add it in the cart
			driver.findElement(By.xpath("//div[@id='design_archives']//div[1]//div[2]//div[1]//div[2]//div[2]//a[text()='Add to Cart']")).click();
