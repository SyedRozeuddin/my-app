...
public class Baseball_Men_Shirt_N3142 {
	 ...
	 @BeforeTest
		...
		public void profile() {
			...
			driver.findElement(By.xpath("//div[@id='design_archives']//div[1]//div[3]//div[1]//div[2]//div[2]//div[1]//a[@role='button']")).click();
...
//          this is to save the entire the uniform edit and move back to the design locker
		...
		public void add_to_cart() throws InterruptedException{
			...
			driver.findElement(By.xpath("//div[@id='design_archives']//div[2]//div[1]//div[1]//div[2]//div[2]//a[text()='Add to Cart']")).click();
