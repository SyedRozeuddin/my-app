...
public class BasketBall_Youth_Jersey_N2206 {
	 ...
	 @Test(dependsOnMethods = {"login"})
		public void profile() {
			...
			driver.findElement(By.xpath("//div[@class='row']//div[3]//div[1]//div[1]//div[2]//div[2]//a[@role='button']")).click();
...
//			after selecting the edit design select color of that uniform
			driver.findElement(By.xpath("//div[@class='btn-group tile-wrapper'][@data-color-id='47']")).click();
...
//       this is to save the entire the uniform edit and move back to the design locker
	 ...
	 @Test(dependsOnMethods = {"edit_design"})
		public void add_to_cart() throws InterruptedException{
			...
			driver.findElement(By.xpath("//div[@class='row']//div[3]//div[2]//div[1]//div[2]//div[2]//a[contains(text(),'Add to Cart')]")).click();
