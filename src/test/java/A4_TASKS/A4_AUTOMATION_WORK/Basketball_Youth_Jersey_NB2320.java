...
public class Basketball_Youth_Jersey_NB2320 {
	 ...
	 static String url = "https://customa4.com/";
		...
		public void profile() {
			...
			driver.findElement(By.xpath("//div[@class='row']//div[5]//div[2]//div[1]//div[2]//div[2]//a[@role='button']")).click();
...
//			after selecting the edit design select color of that uniform
			driver.findElement(By.xpath("//div[@class='btn-group tile-wrapper'][@data-color-id='57']")).click();
...
//    this is to save the entire the uniform edit and move back to the design locker
		...
		public void add_to_cart() throws InterruptedException{
			...
			driver.findElement(By.xpath("//div[@class='row']//div[5]//div[3]//div[1]//div[2]//div[2]//a[contains(text(),'Add to Cart')]")).click();
