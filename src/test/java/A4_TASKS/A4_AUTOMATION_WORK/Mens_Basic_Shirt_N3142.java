...
public class Mens_Basic_Shirt_N3142 {
	 ...
	 @BeforeTest
		...
		public void profile() {
			...
			driver.findElement(By.xpath("//div[@class='row']//div[6]//div[3]//div[1]//div[2]//div[2]//a[@role='button']")).click();
...
//			after selecting the edit design select color of that uniform
			driver.findElement(By.xpath("//button[contains(text(),'MRO')]")).click();
...
//    this is to save the entire the uniform edit and move back to the design locker
		...
		public void add_to_cart() throws InterruptedException{
			...
			driver.findElement(By.xpath("//div[@class='row']//div[7]//div[1]//div[1]//div[2]//div[2]//a[contains(text(),'Add to Cart')]")).click();
